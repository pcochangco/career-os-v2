    ...
    return FixtureRoadmap(
        ...
        milestones=(
            FixtureMilestone(
                ...
                outcome="Understand the target, the essential concepts, and your true starting point.",
                steps=(
                    FixtureStep(
                        kind="learn",
                        title=f"Define what good looks like for {goal_title}",
                        objective="Turn the goal into a concrete outcome you can recognize in practice.",
                        action=(
                            f"Write a one-page success brief for this outcome: {outcome}. Include what "
                            "you will be able to explain, do, or produce."
                        ),
                        completion_condition="A success brief exists with at least three observable outcomes.",
                        effort_label="Short focused session",
                    ),
                    FixtureStep(
                        kind="practice",
                        title="Map the essential foundations",
                        objective="Identify the smallest set of concepts or skills that everything else uses.",
                        action=(
                            "Create a foundation map with five to seven essentials. Mark what you already "
                            f"know based on this experience: {discovery.existing_experience}."
                        ),
                        completion_condition="The foundation map is written and every item has a confidence note.",
            ...
            FixtureMilestone(
                ...
                steps=(
                    FixtureStep(
                        ...
                        action=(
                            "Follow one credible end-to-end introduction and reproduce its key workflow "
                            "in your own words or environment."
                        ),
                        completion_condition="A complete walkthrough exists with your own notes at each stage.",
                    ...
                    FixtureStep(
                        ...
                        action=(
                            f"Create a small practice output related to {goal_title}. Respect this context: "
                            f"{discovery.relevant_constraints}."
                        ),
                        completion_condition="The practice output works and includes a short reflection on two gaps.",
            ...
            FixtureMilestone(
                ...
                outcome="Produce convincing evidence that the goal has moved from intention to ability.",
                steps=(
                    FixtureStep(
                        kind="prove",
                        ...
                        completion_condition="The final output is complete, accessible, and can be reviewed by another person.",
                        effort_label="Multi-session project",
                    ),
                    FixtureStep(
                        kind="prove",
                        title="Review, explain, and package your learning",
                        objective="Confirm understanding and make the result useful beyond the app.",
                        action=(
                            "Explain your approach, decisions, strongest result, and remaining gap. Package "
                            "the final output with a concise summary."
                        ),
                        completion_condition="A clear summary and final evidence link or artifact are ready to share.",
